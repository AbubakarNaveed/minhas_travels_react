...
const ReviewCard = ({
  ...
  return (
    <div>
      <div
        className="container flex flex-col w-full max-w-lg p-2 mx-auto divide-y rounded-md divide-black shadow-3xl bg-[#feffffe8] border-slate-300 border-[1px] border-solid
]"
      >
        <div className="flex lg:justify-between p-4 lg:flex-row flex-col items-center gap-1 lg:gap-0">
